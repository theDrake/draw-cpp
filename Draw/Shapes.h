...
{
public:
	Shape(vector<Point2D *> points, const double r, const double g, const double b, bool filled);
	virtual ~Shape();
	virtual void Draw() = 0;
...
{
public:
	Line(vector<Point2D *> points, const double r, const double g, const double b);
	void Draw();
};
...
{
public:
	BezierCurve(vector<Point2D *> points, const double r, const double g, const double b);
	void Draw();
...
{
public:
	Rectangle(vector<Point2D *> points, const double r, const double g, const double b, bool filled);
	void Draw();
...
{
public:
	Triangle(vector<Point2D *> points, const double r, const double g, const double b, bool filled);
	void Draw();
};
...
{
public:
	Pentagon(vector<Point2D *> points, const double r, const double g, const double b, bool filled);
	void Draw();
};
